 ...
 *******************************************************************************/
package com.framework.greendroid.pulltorefresh;
...
import com.framework.greendroid.pulltorefresh.internal.FlipLoadingLayout;
import com.framework.greendroid.pulltorefresh.internal.LoadingLayout;
import com.framework.greendroid.pulltorefresh.internal.RotateLoadingLayout;
import com.framework.greendroid.pulltorefresh.internal.Utils;
import com.framework.greendroid.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public final void onRefreshComplete() {
        DebugLog.i("onRefreshComplete", isRefreshing() + "==");
        if (isRefreshing()) {
    ...
    public static enum AnimationStyle {
        ...
        static AnimationStyle getDefault() {
            return FLIP;//default ROTATE shaxn update
        }
