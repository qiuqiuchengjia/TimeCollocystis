package com.framework.greendroid.switchbutton;
...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray ta = attrs == null ? null : getContext().obtainStyledAttributes(attrs, R.styleable.KSW_SwitchButton);
        if (ta != null) {
            thumbDrawable = ta.getDrawable(R.styleable.KSW_SwitchButton_kswThumbDrawable);
            thumbColor = ta.getColorStateList(R.styleable.KSW_SwitchButton_kswThumbColor);
            margin = ta.getDimension(R.styleable.KSW_SwitchButton_kswThumbMargin, margin);
            marginLeft = ta.getDimension(R.styleable.KSW_SwitchButton_kswThumbMarginLeft, margin);
            marginRight = ta.getDimension(R.styleable.KSW_SwitchButton_kswThumbMarginRight, margin);
            marginTop = ta.getDimension(R.styleable.KSW_SwitchButton_kswThumbMarginTop, margin);
            marginBottom = ta.getDimension(R.styleable.KSW_SwitchButton_kswThumbMarginBottom, margin);
            thumbWidth = ta.getDimension(R.styleable.KSW_SwitchButton_kswThumbWidth, thumbWidth);
            thumbHeight = ta.getDimension(R.styleable.KSW_SwitchButton_kswThumbHeight, thumbHeight);
            thumbRadius = ta.getDimension(R.styleable.KSW_SwitchButton_kswThumbRadius, Math.min(thumbWidth, thumbHeight) / 2.f);
            backRadius = ta.getDimension(R.styleable.KSW_SwitchButton_kswBackRadius, thumbRadius + density * 2f);
            backDrawable = ta.getDrawable(R.styleable.KSW_SwitchButton_kswBackDrawable);
            backColor = ta.getColorStateList(R.styleable.KSW_SwitchButton_kswBackColor);
            backMeasureRatio = ta.getFloat(R.styleable.KSW_SwitchButton_kswBackMeasureRatio, backMeasureRatio);
            animationDuration = ta.getInteger(R.styleable.KSW_SwitchButton_kswAnimationDuration, animationDuration);
            fadeBack = ta.getBoolean(R.styleable.KSW_SwitchButton_kswFadeBack, true);
            tintColor = ta.getColor(R.styleable.KSW_SwitchButton_kswTintColor, tintColor);
            textOn = ta.getString(R.styleable.KSW_SwitchButton_kswTextOn);
            textOff = ta.getString(R.styleable.KSW_SwitchButton_kswTextOff);
            textMarginH = ta.getDimension(R.styleable.KSW_SwitchButton_kswTextMarginH, textMarginH);
            ta.recycle();
        }
