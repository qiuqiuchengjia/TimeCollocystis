...
//        setTransitionEffect(TransitionEffect.valueOf(transitions[effect]));
    ...
    public boolean onInterceptTouchEvent(MotionEvent arg0) {
        /**
         * Add try catch to fix bug: Which said in
         * http://stackoverflow.com/questions/16459196/java-lang-illegalargumentexception
         * -pointerindex-out-of-range-exception-dispat
         * ======================================================================================
         * And it's token reference from [HackyViewPager](https://github.com/habzy/PhotoView): Hacky
         * fix for Issue #4 and http://code.google.com/p/android/issues/detail?id=18990
         * <p/>
         * ScaleGestureDetector seems to mess up the touch events, which means that ViewGroups which
         * make use of onInterceptTouchEvent throw a lot of IllegalArgumentException: pointerIndex
         * out of range.
         * <p/>
         * There's not much I can do in my code for now, but we can mask the result by just catching
         * the problem and ignoring it.
         * =========TheEnd======================================================================
         */
        try {
    ...
    private void logState(View v, String title) {
        Log.v(TAG,
                title + ": ROT (" + ViewHelper.getRotation(v) + ", " + ViewHelper.getRotationX(v)
                        + ", " + ViewHelper.getRotationY(v) + "), TRANS ("
                        + ViewHelper.getTranslationX(v) + ", " + ViewHelper.getTranslationY(v)
                        + "), SCALE (" + ViewHelper.getScaleX(v) + ", " + ViewHelper.getScaleY(v)
                        + "), ALPHA " + ViewHelper.getAlpha(v));
    }
