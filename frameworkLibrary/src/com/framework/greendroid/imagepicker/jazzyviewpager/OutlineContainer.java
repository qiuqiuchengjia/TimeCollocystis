...
public class OutlineContainer extends FrameLayout implements Animatable {
    ...
    private void init() {
        ...
        mOutlinePaint.setStrokeWidth(ImageTools.dpToPx(getResources(), 2));
        mOutlinePaint.setColor(getResources().getColor(R.color.holo_blue));
        mOutlinePaint.setStyle(Style.STROKE);

        int padding = ImageTools.dpToPx(getResources(), 10);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int offset = ImageTools.dpToPx(getResources(), 5);
        ...
        Rect rect =
                new Rect(offset, offset, getMeasuredWidth() - offset, getMeasuredHeight() - offset);
