...
public class ViewParams {
    ...
    public enum TransitionEffect {
        Standard, //
        Tablet, //
        CubeIn, // There may be some bugs in the model, need to fix
        // JazzyViewPager.
        CubeOut, //
        FlipVertical, //
        FlipHorizontal, //
    ...
    public boolean isCanViewImage() {
        return isCanViewImage;
    }

    public void setCanViewImage(boolean canViewImage) {
        isCanViewImage = canViewImage;
    }
    ...
    private ArrayList<TransitionEffect> mTransitionEffects = new ArrayList<TransitionEffect>();
    ...
    public boolean isItemClickEnable() {
        return mIsItemClickEnable;
    }

    public void setItemClickEnable(boolean itemClickEnable) {
        mIsItemClickEnable = itemClickEnable;
    }
    ...
    public int getmBarTitleColor() {
        return mBarTitleColor;
    }

    public void setmBarTitleColor(int mmBarTitleColor) {
        this.mBarTitleColor = mmBarTitleColor;
    }
