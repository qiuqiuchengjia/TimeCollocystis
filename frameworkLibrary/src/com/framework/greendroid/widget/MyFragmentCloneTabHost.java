 ...
 */
public class MyFragmentCloneTabHost extends FrameLayout {
    private static final String LOGTAG = LogUtil
            .makeLogTag(MyFragmentCloneTabHost.class);
    ...
    public MyFragmentCloneTabHost(Context context) {
    ...
    public MyFragmentCloneTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        getTabWidget().setDividerDrawable(android.R.color.transparent);
        mTabContent = (FrameLayout) findViewById(containerId);
        if (mTabContent == null) {
...
//        }
    ...
    private FragmentTransaction doTabChanged(String tabId,
        ...
        if (newTab == null) {//2015-12-8 author shaxiaoning
        ...
        if (mLastTab != newTab) {
            ...
            if (newTab != null) {
                if (newTab.fragment == null) {
                    ...
                    // modify author sxn 2015-1-26
                    //fragments.add(newTab.fragment);
                    //DebugLog.i(LOGTAG, "-------------------");
