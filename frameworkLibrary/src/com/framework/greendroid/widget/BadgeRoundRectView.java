...
public class BadgeRoundRectView extends TextView {

    private boolean mHideOnNull = true;

    public BadgeRoundRectView(Context context) {
        this(context, null);
    }

    public BadgeRoundRectView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public BadgeRoundRectView(Context context, AttributeSet attrs, int defStyle) {
...
//        setTypeface(Typeface.DEFAULT_BOLD);
        ...
        setPadding(dip2Px(7), dip2Px(0), dip2Px(7), dip2Px(0));

        // set default background
        setBackground(7, Color.parseColor("#ff8181"));
