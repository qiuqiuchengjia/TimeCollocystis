 ...
 *
 */
public class MyFragmentTabHostCustom extends View {
	...
	public MyFragmentTabHostCustom(Context context) {
	...
	public MyFragmentTabHostCustom(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void addTab(Class<?> clss, String tag, Bundle args) {
